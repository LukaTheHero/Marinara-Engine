...
export function PersonasPanel() {
  ...
  // Which persona group folders are expanded lives in the UI store so the
  ...
  const handleDeleteGroup = useCallback(
    ...
    [deletePGroup, expandedPersonaGroupIds, togglePersonaGroupExpanded],
  );
    ...
    <div className="flex min-h-full flex-col gap-2 p-3">
      ...
      <div className="flex flex-col gap-0.5">
        ...
        {parsedGroups.map((group) => {
          ...
          const isExpanded = (folderFilterActive && folderMemberIds.length > 0) || expandedPersonaGroupIds.includes(group.id);
              ...
              <div
                ...
                onClick={(event) =>
                  handleFolderRenameGesture(group.id, event, {
                    onSingleClick: () => togglePersonaGroupExpanded(group.id),
                    onRename: () => {
